...
const MediaCard = ({ post, refetch }) => {
    ...
    return (
        <div className="rounded-xl shadow-md w-full bg-gray-50 text-gray-800">
            <div className="flex items-center justify-between p-3 rounded-xl bg-sky-200">
                <div className="flex items-center space-x-2">
                    <img src={userPhotoURL} alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm bg-gray-100 border-gray-300" />
            ...
            <img src={image} alt="" className="object-contain object-center w-full h-60 pt-5" />
            ...
            <div className="p-3 bg-red-100">
                <div className="flex items-center justify-between">
                    ...
                    <button className='flex items-center justify-center bg-rose-700 px-2 py-1 rounded'>
                            ...
                            <>
                                {
                                    comments?.map(comment =>
                                        <p key={comment._id} className="text-sm mt-1">
                                            <span className="text-base font-semibold mr-2 text-sky-600">{comment.commentedUserName}:</span>{comment.comment}
                                        </p>
                                    )
                                }
                            </>
